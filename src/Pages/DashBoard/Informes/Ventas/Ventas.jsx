...
import SingleVentasTD from "./SingleVentasTD";
...
const Ventas = () => {
  ...
  return (
    <div className='main-container ventas'>
      <div className='ventas-header'>
        <h4>Informes</h4>
        <p>
          Información general sobre todas las ventas de entradas de tus eventos,
          incluidos gastos de gestión
        </p>
      </div>
