...
import SingleTraficoTD from "./SingleTraficoTD";
...
const Trafico = () => {
  ...
  return (
    <div className='main-container trafico'>
      <div className='trafico-header'>
        <h4>Informes</h4>
        <p>
          Descubre cuántos de los visitantes que visitan la página de tu evento
          acaban comprando las entradas
        </p>
      </div>
      <div className='eventos-container'>
        ...
        <div className='acceso-table trafico-table table-responsive'>
          <table>
            <thead>
              <tr>
                <th>Evento</th>
