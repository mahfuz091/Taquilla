...
const Compras = () => {
  ...
  const totalPages = Math.ceil(pedidos.length / eventsPerPage);

  const indexOfLastEvent = currentPage * eventsPerPage;
  const indexOfFirstEvent = indexOfLastEvent - eventsPerPage;
  const currentEvents = pedidos.slice(indexOfFirstEvent, indexOfLastEvent);
      ...
      <div className='compras-container'>
        ...
        <div className='pedidos-table table-responsive'>
          <table>
            ...
            {currentEvents.map((pedido) => (
              <SinglePedidosTableRow
                key={pedido.id}
                pedido={pedido}
              ></SinglePedidosTableRow>
            ))}
        ...
        <div className='pagination'>
          ...
          <div className='pagination-button-group'>
            ...
            {Array.from(
              { length: Math.ceil(pedidos.length / eventsPerPage) },
              (_, i) => (
                <button
